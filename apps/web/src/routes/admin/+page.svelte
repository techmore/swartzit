<script>
  ...
  let drawExecutable = 'draw-things-cli', drawModelsDir = '', drawModel = '', drawWidth = 1024, drawHeight = 1024, drawSteps = 4, drawCfg = '', drawSeed = '', drawLoras = '[]', drawLoraRows = [], drawOutputPath = '', drawPostsPerRun = 1, drawTitlePrefix = 'Draw Things generation';
